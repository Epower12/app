...
// Photos in /public/img/landing are AI-generated with Ideogram (scripts/generate-landing-images.sh).
const LANDING_IMG = '/img/landing';
...
export const MEDIA = {
    hero: {
        img: `${LANDING_IMG}/why-debate.webp`,
    ...
    whyDebate: { img: `${LANDING_IMG}/why-debate.webp` },
    whyMatter: { img: `${LANDING_IMG}/why-matter.webp` },
    whyFriends: { img: `${LANDING_IMG}/why-friends.webp` },

    finale: { img: `${LANDING_IMG}/finale-celebration.webp` },
