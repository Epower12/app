...
const buildFaq = (region: VisitorRegion) => [
    {
    ...
    },
    {
        ...
        a: `${region === 'us' ? 'Soccer' : 'Football'}, ice hockey, basketball, Formula 1 (Top 10 plus bonus questions) and tennis, with more competitions added over time.`,
    },
    {
...
export default function Faq({ region }: { region: VisitorRegion }) {
    const faq = buildFaq(region);
    return (
